...
public class NotesList extends ListActivity {
    ...
    public MyToastData myToastData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences("useMyTheme", MODE_PRIVATE);//获取主题更换状态
        mUseMyTheme = sharedPreferences.getBoolean("useMyTheme", true);//第一次默认设置为亮色主题
        if (!mUseMyTheme) {
            setTheme(R.style.barktheme);//黑色主题
        } else {
...
//        setContentView(R.layout.main_activity);
        ...
        myToastData=new MyToastData(R.layout.mytoastview,R.id.mytoastview_title,R.id.mytoastview_text);
        ...
        // noteslist_item.xml
        int[] viewIDs = { android.R.id.text1,R.id.mtime_text };
...
//            Toast.makeText(this,"NotesList_uri: "+uri.toString()
//                    ,Toast.LENGTH_SHORT).show();
//            Toast.makeText(this,"NotesList_getData: "+getIntent().getData().toString()
//                    ,Toast.LENGTH_SHORT).show();
//            Toast.makeText(this,"NotesList_被点击的按钮ID "+getSelectedItemId()
//                    ,Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_paste:
           ...
           * 活动的意图过滤器必须有动作ACTION_PASTE。
           * 实际上，这将启动记事本中的NoteEditor活动。
           */


            new MyToast(this,myToastData).setMText("你点击了past按钮","如此输出了一下").show();
...
//
            ...
            case R.id.menu_option_changetheme:

            new MyToast(this,myToastData).setMText("切换背景","测试").show();
...
//        case R.id.menu_option_blackback:
//
//            setTheme(R.style.barktheme);
//
//            return true;
        default:
